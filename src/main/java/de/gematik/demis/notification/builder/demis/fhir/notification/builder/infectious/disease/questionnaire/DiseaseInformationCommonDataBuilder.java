...
@Setter
public class DiseaseInformationCommonDataBuilder {
  ...
  public QuestionnaireResponse buildExampleDiseaseInformationCommonData(
      Patient notifiedPerson,
      List<QuestionnaireResponse.QuestionnaireResponseItemComponent>
          questionnaireResponseItemComponentList) {

    profileUrl = requireNonNullElse(profileUrl, PROFILE_DISEASE_INFORMATION_COMMON);
    questionnaireUrl = requireNonNullElse(questionnaireUrl, QUESTIONAIRE_DISEASE_QUESTIONS_COMMON);
    status = requireNonNullElse(status, "completed");

    return buildDiseaseInformationCommonData(
        notifiedPerson, questionnaireResponseItemComponentList);
  }

  public QuestionnaireResponse buildDiseaseInformationCommonData(
      Patient notifiedPerson,
      List<QuestionnaireResponse.QuestionnaireResponseItemComponent>
          questionnaireResponseItemComponentList) {
    ...
    questionnaireResponse.setItem(questionnaireResponseItemComponentList);
