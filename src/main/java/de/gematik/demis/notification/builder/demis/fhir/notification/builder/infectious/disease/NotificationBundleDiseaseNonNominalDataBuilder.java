...
import static de.gematik.demis.notification.builder.demis.fhir.notification.utils.DemisConstants.PROFILE_NOTIFICATION_BUNDLE_DISEASE_NON_NOMINAL;
...
public class NotificationBundleDiseaseNonNominalDataBuilder
  ...
  protected String getDefaultProfileUrl() {
    return PROFILE_NOTIFICATION_BUNDLE_DISEASE_NON_NOMINAL;
  }
